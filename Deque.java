...
public class Deque<Item> implements Iterable<Item> {
       ...
       private int size; // 4 bytes
               ...
               private class Node { // 16 Byte object overhead+8 Extra overhead of byte internal classes+8+8+8=48 bytes, n The number of nodes is 48. n bytes
          ...
          //remove No design, parent class Iterator Of remove The method is thrown UnsupportedOperationException("remove");
              }
