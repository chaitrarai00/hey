...
public class RandomizedQueue<Item> implements Iterable<Item> {
  ...
  private class RandomIterator implements Iterator<Item> {
          ...
          private Item[] iterArrays; //The two iterators must be indepe-ndent of each other and have their own random order
          ...
          public Item next() {
                         ...
                         iterArrays[rank] = item; // Place the traversed elements at the end of the queue so that the next iteration will not be selected
                         return item;
                     }
      }
